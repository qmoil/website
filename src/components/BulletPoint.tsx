...
const BulletPoint = ({ title, points }: IBulletPointProps) => {
  return (
    <div className="bg-[#EAEAF0] text-[#090916] flex flex-col md:flex-row justify-between md:mx-8 p-6 sm:p-10 pt-10 sm:pt-20 mb-8 border border-b">
      ...
      <div className="hidden md:w-3/5 font-thin md:flex flex-col gap-2">
        {points.map((point, index) => (
          <div key={index} className='flex gap-6'>
            <span><img src={Target} alt="Bullet point icon" className='inline w-9 h-9'/></span>
            <p>
      ...
      <div className="m-auto md:hidden text-center font-thin flex flex-col gap-4">
        {points.map((point, index) => (
          <div key={index} className='flex flex-col items-center'>
            <span><img src={Target} alt="Bullet point icon" className='w-9 h-9 m-2'/></span>
            <strong className="font-bold">{point.mainPoint}</strong>
