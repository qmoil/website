...
const Card: React.FC<CardProps> = ({ title, content, backgroundImage, targetImage }) => (
  <div
    className="max-w-[538px] max-h-[538px] bg-cover flex flex-col items-center justify-center bg-center border rounded-lg p-10 pt-20 gap-6"
    ...
    <div className="mt-20 sm:mt-24 pt-12 md:mt-28 flex flex-col gap-8">
      ...
      >
        <div className="flex flex-col items-center gap-4 text-2xl sm:text-3xl md:text-4xl font-bold text-center text-[#1C1B42]">
          <h2>About Q and M</h2>
          <p className="text-base sm:text-lg font-thin px-5 ">
